     ...
     <span className='text-xl'><SlOptionsVertical /></span>
      ...
      pb-2'>
       <img src='/avatar.jpeg' alt='avatar' className='w-[30px] h-[30px] rounded-full object-cover'/>
        <span className='font-space text-xl' style={{color:'#31D8EE'}}>AlgoHub</span><span className='text-2xl'><LuBell /></span>
      </div>
      ...
      <div className='w-full flex px-6 items-center'>
        <div className='flex flex-col w-[340px] h-[173px] px-3 pb-8 pt-3 rounded-md relative'
         ...
         <div><h1 className='text-white font-space'> <span className='inline-flex gap-2 items-center'>My Wallet  < IoMdWallet/> </span>
        </h1> 
         <span className='inline-flex gap-2 items-center text-white'>0x2xvv.....d34dhdcv<MdContentCopy /></span>
         </div>
          <div className='p-1 bg-white rounded-xl inline-flex items-center'><span className='text-xs'>USD</span> <span className='text-xs'><IoIosArrowDown /></span></div>
         </div>
         <div className='flex gap-2 '>
            <div className='bg-white w-[46px] h-[46px] rounded-full flex items-center justify-center'>
              <img src='/algologo.png' alt='Algo logo' className='w-[31px] h-[31px]'/>
            </div> 
            <div className='flex flex-col'>
              <span className='font-space text-white'> {Algo_Balance} 'ALGO'</span>
              <span className='font-noto text-white'>
                {Usd_Balance}
              </span>
            </div>
         </div>
