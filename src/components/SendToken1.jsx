	...
	return (
      ...
      flex items-center space-x-2 justify-center' style={{ borderColor: '#F4A466' }}>
			...
			<div className='flex justify-between items-center mb-5 gap-3 px-4'>
				...
				<Link to='/sendtoken2'>
					<button onClick={() => makeTransaction(localStorage.getItem("user"), localStorage.getItem("receiver"), localStorage.getItem("amount"))} className='w-[162px] h-[43px] border border-b-2 rounded-md text-white font-space'
